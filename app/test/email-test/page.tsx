...
export default function EmailTestPage() {
  ...
  const [testDescription, setTestDescription] = useState('Test security alert from the test page')
  ...
  return (
    <div className="container mx-auto p-8">
      <h1 className="text-3xl font-bold mb-6">Email Alert Test Page</h1>
      
      <div className="space-y-8">
        <div className="p-6 bg-gray-100 dark:bg-gray-800 rounded-lg">
          <h2 className="text-xl font-semibold mb-4">Test Alert Modal</h2>
          <p className="mb-4">This will open the security alert modal which should trigger an email.</p>
          <Button 
        ...
        <div className="p-6 bg-gray-100 dark:bg-gray-800 rounded-lg">
          ...
          <p className="mb-4">This will directly call the email API endpoint.</p>
          <div className="mb-4">
            <label className="block text-sm font-medium mb-2">Alert Description:</label>
            <input
              type="text"
      ...
      <SecurityAlertModal
        ...
        onAlertComplete={() => {
          setStatus('success')
          setMessage('Alert completed and email should have been sent!')
        }}
